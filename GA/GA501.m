...
Generation=1;
while Generation<maxGenerationn+1
   for j=1:2:popsize 
      %选择操作
...
plot(1:Generation,ymax,'linewidth',2) 
hold on;
plot(1:Generation,ymean,'linewidth',2)
xlabel('进化代数');ylabel('最大/平均适应度');xlim([1 maxGenerationn]);
legend('最大适应度','平均适应度');
box off;hold off;